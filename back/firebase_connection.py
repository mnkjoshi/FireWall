...
class firebase_connection:
    def __init__(self):
        self.__cred_obj = firebase_admin.credentials.Certificate('hackathons-manav-0f96b5aefb06.json')
        self.__default_app = firebase_admin.initialize_app(self.__cred_obj, {
            'databaseURL': 'https://hackathons-manav-default-rtdb.firebaseio.com/',
            'storageBucket': 'hackathons-manav.appspot.com'
        })
